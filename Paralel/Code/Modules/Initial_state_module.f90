...
module Initial_state_module
    ...
    !******************************************************************************************************************************!
    ! read input file
    subroutine Read_parameters(params_file, nparts, density, mass, sigma, epsilon, cutoff, temp_room, temp_init, & 
    bimodal, disorder_system, thermostat, integrator, time_step, init_steps, steps, measure_steps, traj_steps, boxes, &
    observables_file, MSD_file, positions_file, gofr_file)
